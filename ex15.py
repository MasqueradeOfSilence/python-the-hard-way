...
# 7. Uncommenting what was previously commented out in order to solve this one.
#   Result: it worked as usual, but cleaned out the streams after for best Python practice.
